...
class BorrowingController extends Controller
{
    ...
    const RETURNED_DATE = Carbon::now('Africa/Casablanca');
    ...
    public function borrow(Request $request)
    {
        ...
        $borrowing->borrowed_at =  self::RETURNED_DATE;
        $borrowing->must_be_returned_at =  (self::RETURNED_DATE)->addDay(15);
    ...
    public function collect()
    {
        ...
        $borrowing1 = Borrowing::where('must_be_returned_at','<',(self::DATE)->addDays(1));
        $borrowing2 = Borrowing::where('must_be_returned_at','<',(self::DATE)->addDays(2));
        $borrowings = Borrowing::where('must_be_returned_at','<',(self::DATE))
