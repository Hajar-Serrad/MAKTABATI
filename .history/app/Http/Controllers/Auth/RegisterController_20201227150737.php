...
{    /**
    ...
    public function showform($id)
    {
        ...
        return view('auth.registerbis',compact('data'))->with('success', 'Your email was verified. Now you can continue your registration!');
    }
    ...
    public function register(Request $request)
    {
        ...
        if ($validation->fails())  {
            session()->flash('error', 'Please verify the data you entered! Your password must to have at least 8 characters!');
