...
class BorrowingController extends Controller
{
    ...
    public function index()
    {
        ...
        $users = User::all();
        return view('borrowing',compact('borrowings','users'));
    }
    ...
    public function borrow(Request $request)
    {
        ...
        */
        ...
        $copy = $copy_copy->editor;
        $book = $book->title;
        \Mail::to($user->email)->send(new BookBorrowed($firstname,$book,$copy,$borrowing));
        session()->flash('success','Your request has been accepted. Please check your email for more informations!');
        return redirect()->back()->withInput();
    }
/*
