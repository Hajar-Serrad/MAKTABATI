...
class BorrowingController extends Controller
{
    ...
    public function borrow(Request $request)
    {
        ...
        $borrowing->borrowed_at =  Carbon::now('Africa/Casablanca');
        $borrowing->must_be_returned_at =  Carbon::now('Africa/Casablanca')->addDay(15);
    ...
    public function collect()
    {
        ...
        foreach($borrowings as $borrowing)
        {
            ...
            file_put_contents('C:\Users\Administrateur\Desktop\CollectEmails.txt',$user->email);  // crée le fichier collectEmails.txt s'il n'existe pas dans le répertoire (C:\Users\Administrateur\Desktop\) et met dedans les mails des personnes qui doivent immediatement retourner leurs emprunts    
        }
