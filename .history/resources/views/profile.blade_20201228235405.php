        ...
        <div  class="card-body" style="margin: 15px; margin-right: 0; padding: 10px; background-color:rgb(234, 206, 255);">
            ...
            <div class="row"> 
                ...
                <div class="col-sm-7">
                 ...
                 <div class="row">
                   ...
                   <a class="col-sm-2" href="#" title="Click here to see more details" data-toggle="modal" data-target="#Modal1"><b>{{ $array['n1'] }} &nbsp;&nbsp; → </b></a>
                     <!-- MODAL -->
            ...
            <!--Table body-->
                 ...
                 <div class="row">
                   ...
                   <a class="col-sm-2" href="#" title="Click here to see more details" data-toggle="modal" data-target="#Modal2"><b>{{ $array['n2'] }} &nbsp;&nbsp; →</b></a>
                        <!-- MODAL -->
