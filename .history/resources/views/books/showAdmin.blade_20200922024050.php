...
@section('content')
    ...
    <div class="container">
        ...
        <div class="modal fade" id="Modal0" tabindex="-1" aria-labelledby="ModalLabel0" aria-hidden="true" style="font-family: 'Bahnschrift Condensed'; font-size: 23px; background-color:#190707;">
         ...
         <button class="btn btn-light btn-lg" data-toggle="modal" data-target="#Modal00" style="background-color: #A4A4A4; color:whitesmoke; padding-top: 100px">Delete</button> 
                     <!-- Modal 00-->
