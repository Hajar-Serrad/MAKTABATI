                   ...
                   <span class="col-sm-2" data-toggle="modal" data-target="#Modal">{{ $array['n1'] }}</span>
                     ...
                     <div class="modal fade" id="Modal" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true" >
                      <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content" style="font-family: 'Bahnschrift Condensed'; font-size: 19px; background-color: whitesmoke;">
                            <div class="modal-header"> 
                              <h3 class="badge badge-pill badge-light"> Books I'm borrowing </h3>
                            </div>
