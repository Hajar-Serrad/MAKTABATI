        ...
        <div  class="card-body" style="margin: 15px; margin-right: 0; padding: 10px; background-color:rgb(234, 206, 255);">
            ...
            <!--Table body-->
                 ...
                 <div class="row">
                   ...
                   <span class="col-sm-2" data-toggle="modal" data-target="#Modal2">{{ $array['n2'] }}</span>
                        <!-- MODAL -->
                     <div class="modal fade" id="Modal2" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true" style="font-family: 'Bahnschrift Condensed'; font-size: 23px; background-color:whitesmoke;">
                      <div class="modal-dialog modal-dialog-centered modal-lg">
            ...
            <tbody>
                @php
                    $nbr = 0;
                @endphp
                @foreach ($borrowingHs as $borrowing)
                     <tr >
                       @foreach ($books as $book)
                           @if ($borrowing->ISBN == $book->ISBN)
                                <th scope="row">{{ ++$nbr }}</th>   
