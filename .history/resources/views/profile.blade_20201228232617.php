        ...
        <div  class="card-body" style="margin: 15px; margin-right: 0; padding: 10px; background-color:rgb(234, 206, 255);">
                ...
                <div class="col-sm-7">
                 ...
                 <div class="row">
                   ...
                   <span class="col-sm-2" data-toggle="modal" data-target="#Modal1">{{ $array['n1'] }}</span>
                     <!-- MODAL -->
                     <div class="modal fade" id="Modal1" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true" style="font-family: 'Bahnschrift Condensed'; font-size: 23px; background-color:whitesmoke;">
                      <div class="modal-dialog modal-dialog-centered modal-lg">
                          <div class="modal-content" style="background-color: #1B0A2A; color: whitesmoke;">
                            <div class="modal-header"> 
                              <span class="badge badge-primary" style="font-size:28px; letter-spacing:1ex; margin-left:120px;"> Books I'm borrowing </span>
                            </div>
            ...
            <!--Table body-->
                 ...
                 <div class="row">
                   ...
                   <span class="col-sm-7"><span class="badge badge-primary" style="padding: 7px; font-size:15px;">Number of books I have already borrowed</span></span> 
                   <span class="col-sm-2" data-toggle="modal" data-target="#Modal2">{{ $array['n2'] }}</span>
                        <!-- MODAL -->
                     <div class="modal fade" id="Modal2" tabindex="-1" style="font-family: 'Bahnschrift Condensed'; font-size: 18px; background-color:whitesmoke;">
                      <div class="modal-dialog modal-dialog-centered modal-lg">
                          <div class="modal-content" style="background-color: #151515; color: whitesmoke;">
                            <div class="modal-header"> 
                              <span class="badge badge-primary" style="font-size:28px; letter-spacing:1ex; margin-left:120px;"> Books I have already borrowed</span>
                            </div>
                              <div class="modal-body">
                     ...
                     <tr >
                       @foreach ($books as $book)
                           @if ($Bbook->ISBN == $book->ISBN)
                                ...
                                <td>{{ $Bbook->must_be_returned_at }}</td>
