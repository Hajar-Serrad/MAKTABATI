          ...
          <div class="row">
              ...
              <div class="col-sm-7">
               ...
               <div class="row">
                 ...
                 <span class="col-sm-4"><span class="badge badge-pill badge-light" style="rgb(209, 171, 219); padding: 7px; font-size:17px;">Email</span></span> 
                 <span class="col-sm-4">{{ $user->email }}</span>
