         ...
         <div class="col-sm-11">
          ...
          <div class="row">
              ...
              <div class="col-sm-5">
               <div class="row" >
                 <div class="col-sm-6">
                  &nbsp;&nbsp;<span class="col-sm-3"><span class="badge badge-pill badge-dark" style="padding: 10px;">Student Code</span></span> 
                 <span class="col-sm-3">{{ $user->person_id }}</span>
                </div>
               </div> <br> 
               <div class="row">
                 <div class="col-sm-6">
                  &nbsp;&nbsp;<span class="col-sm-3"><span class="badge badge-pill badge-dark" >Firstname</span></span> 
                 <span class="col-sm-3">{{ $user->firstname }}</span>
                </div>
               </div> <br>   
               <div class="row">
                 <div class="col-sm-6">
                  &nbsp;&nbsp;<span class="col-sm-3"><span class="badge badge-pill badge-dark" >Lastname</span></span> 
                 <span class="col-sm-3">{{ $user->lastname }}</span>
                </div>
               </div> <br>   
               <div class="row">
                 <div class="col-sm-6">
                &nbsp;&nbsp; <span class="col-sm-3"><span class="badge badge-pill badge-dark" >Class</span></span> 
              ...
              <div class="col-sm-7">
               <div class="row">
                 <div class="col-sm-6">
                 <span class="col-sm-3"><span class="badge badge-pill badge-dark" >Email</span></span> 
                 <span class="col-sm-3">{{ $user->email }}</span>
                </div>
               </div> <br> 
               <div class="row">
                 <div class="col-sm-6">
                 <span class="col-sm-3"><span class="badge badge-pill badge-dark">Phone</span></span> 
                 <span class="col-sm-3">{{ $user->phone }}</span>
                </div>
               </div> <br>
               <div class="row">
                 <div class="col-sm-6">
                 <span class="col-sm-3"><span class="badge badge-pill badge-dark" >Address</span></span> 
