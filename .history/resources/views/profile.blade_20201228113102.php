...
<div style="padding-top: 150px; padding-left: 40px;">
  <div class="row">
    ...
    <div class="col-sm-12" style="font-size: 19px; font-family: sans-serif; ">
         <div class="row">
           <div class="col-sm-4">
              <img src="{{ asset('images/members/'.$user->image) }}" class="rounded-circle" alt="Profile Picture" width="100" height="100">
           </div>
         </div> <br> <br>
         <div class="row">
