...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top" >
    ...
    @auth
    <li class="nav-item avatar dropdown" >
      <a id="avatar" class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-55" data-toggle="dropdown"
        ...
        <img src="{{ asset('images/members/'.Auth::user()->image) }}" class="rounded-circle z-depth-0"
          alt="avatar image" height="70px;" width="70px;" >
      </a>
      <div class="dropdown-menu dropdown-menu-lg-right dropdown-secondary"
