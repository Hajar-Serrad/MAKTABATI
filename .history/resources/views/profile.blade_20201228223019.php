                   ...
                   <span class="col-sm-2" data-toggle="modal" data-target="#Modal">{{ $array['n1'] }}</span>
                     ...
                     <div class="modal fade" id="Modal" tabindex="-1"  >
                      <div class="modal-dialog modal-lg">
                          <div class="modal-content" style="font-family: 'Bahnschrift Condensed'; font-size: 21px; background-color: whitesmoke;">
                            <div class="modal-header"> 
                              <span class="badge badge-dark" style="font-size:28px; letter-spacing:1ex; margin-left:100px;"> Books I'm borrowing </span>
                            </div>
