...
<div class="row" >
    <div class="col-sm-11" style="padding-left: 130px;">
            ...
            <tbody>
                @foreach ($users as $user)
                     <tr >
                        ...
                        <td><img src=" {{ asset('images/members/'.$user->image) }} " alt="member picture" height="80px;" width="80px;"></td>
        ...
        <!--Table-->
       <br>
       <button class="btn btn-primary" type="submit"><a href="{{ route('generate_pdf') }}">GENERER</a></button>
    @endauth
    </div>
