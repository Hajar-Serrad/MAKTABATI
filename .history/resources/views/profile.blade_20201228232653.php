            ...
            <!--Table body-->
                 ...
                 <div class="row">
                   ...
                   <span class="col-sm-2" data-toggle="modal" data-target="#Modal2">{{ $array['n2'] }}</span>
                        <!-- MODAL -->
                     <div class="modal fade" id="Modal2" tabindex="-1" style="font-family: 'Bahnschrift Condensed'; font-size: 15px; background-color:whitesmoke;">
                      <div class="modal-dialog modal-dialog-centered modal-lg">
                          <div class="modal-content" style="background-color: #151515; color: whitesmoke;">
                            <div class="modal-header"> 
                              <span class="badge badge-primary" style="font-size:20px; letter-spacing:1ex; margin-left:120px;"> Books I have already borrowed</span>
                            </div>
                              <div class="modal-body">
