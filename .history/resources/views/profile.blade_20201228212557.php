  ...
  <div style="padding-top: 150px; padding-left: 40px; color: black; ">
    <div class="row">
      <div class="col-sm-2">
        ...
        <div  class="card-body" style="margin-left: 150px; padding-top: 10px; padding-bottom: 10px; padding-left: 10px; padding-right: 0; background-color:rgb(227, 206, 222);">
            ...
            <div class="row"> 
                ...
                <div class="col-sm-7">
                 ...
                 <div class="row">
                   ...
                   <span class="col-sm-6"><span class="badge badge-pill badge-light" style="rgb(209, 171, 219);
                 ...
                 <div class="row">
                   ...
                   <span class="col-sm-7"><span class="badge badge-pill badge-dark" style="padding: 7px; font-size:16px;">Number of books I have already borrowed</span></span> 
