                ...
                <div class="col-sm-7">
                 ...
                 <div class="row">
                   ...
                   <span class="col-sm-2" data-toggle="modal" data-target="#Modal">{{ $array['n1'] }}</span>
                     <!-- MODAL -->
                     <div class="modal fade" id="Modal" tabindex="-1" aria-labelledby="ModalLabel2" aria-hidden="true" style="font-family: 'Bahnschrift Condensed'; font-size: 23px; background-color: whitesmoke;">
