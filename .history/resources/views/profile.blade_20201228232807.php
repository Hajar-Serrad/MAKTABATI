                ...
                <div class="col-sm-7">
                 ...
                 <div class="row">
                   ...
                   <span class="col-sm-2" data-toggle="modal" data-target="#Modal1">{{ $array['n1'] }}</span>
                     <!-- MODAL -->
                     <div class="modal fade" id="Modal1" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true" style="font-family: 'Bahnschrift Condensed'; font-size: 1px; background-color:whitesmoke;">
