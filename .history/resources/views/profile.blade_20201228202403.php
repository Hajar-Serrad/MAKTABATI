          ...
          <div class="row">
              ...
              <div class="col-sm-7">
               ...
               <div class="row">
                 ...
                 <span class="col-sm-2"><span class="badge badge-pill badge-light" style="rgb(209, 171, 219); padding: 7px; font-size:17px;">Email</span></span> 
                 <span class="col-sm-5">{{ $user->email }}</span>
               
               </div> <br> <br>
               <div class="row">
                 
                 <span class="col-sm-2"><span class="badge badge-pill badge-dark" style="padding: 7px; font-size:17px;">Phone</span></span> 
                 <span class="col-sm-5">{{ $user->phone }}</span>
              
               </div> <br> <br>
               <div class="row">
                
                 <span class="col-sm-2"><span class="badge badge-pill badge-light" style="rgb(209, 171, 219); padding: 7px; font-size:17px;">Address</span></span> 
               ...
               <div class="row">
                 ...
                 <span class="col-sm-7"><span class="badge badge-pill badge-dark" style="
                 .padding: 7px; font-size:17px;">Number of books I'm borrowing</span></span> 
                 <span class="col-sm-5">{{ $array['n1'] }}</span>
               ...
               <div class="row">
                 <div class="col-sm-7">
                 <span class="col-sm-9"><span class="badge badge-pill badge-light" style="rgb(209, 171, 219); padding: 7px; font-size:16px;">Number of books I have already borrowed</span></span> 
