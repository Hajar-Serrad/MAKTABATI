        ...
        <div  class="card-body" style="margin: 15px; margin-right: 0; padding: 10px; background-color:rgb(234, 206, 255);">
            ...
            <div class="row"> 
                ...
                <div class="col-sm-7">
                 ...
                 <div class="row">
                   ...
                   <span class="col-sm-6"><span class="badge badge-light" style="rgb(209, 171, 219); padding: 7px; font-size:17px;">Number of books I'm borrowing</span></span> 
                   <a class="col-sm-2" href="#" title="Click here to see more details" data-toggle="modal" data-target="#Modal1" style="text-decoration:none;"><b>{{ $array['n1'] }} &nbsp;&nbsp; → </b></a>
                     <!-- MODAL -->
                      ...
                      <div class="modal-dialog modal-dialog-centered modal-lg">
                          <div class="modal-content" style="background-color: #1B0A2A; color: whitesmoke;">
                            <div class="modal-header"> 
                              <span class="badge badge-primary" style="font-size:22px; letter-spacing:0.95ex; margin-left:180px;"> Books I'm borrowing </span>
                            </div>
            ...
            <!--Table body-->
                 ...
                 <div class="row">
                   ...
                   <a class="col-sm-2" href="#" title="Click here to see more details" data-toggle="modal" data-target="#Modal2" style="text-decoration:none;"><b>{{ $array['n2'] }} &nbsp;&nbsp; →</b></a>
                        <!-- MODAL -->
                     <div class="modal fade" id="Modal2" tabindex="-1" style="font-family: 'Bahnschrift Condensed'; font-size: 17px; background-color:whitesmoke;">
                      <div class="modal-dialog modal-dialog-centered modal-lg">
                          <div class="modal-content" style="background-color: #151515; color: whitesmoke;">
                            <div class="modal-header"> 
                              <span class="badge badge-primary" style="font-size:22px; letter-spacing:0.95ex; margin-left:90px;"> Books I have already borrowed</span>
                            </div>
                              <div class="modal-body">
