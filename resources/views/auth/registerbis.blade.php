                                          ...
                                          required="true" >
                                            ...
                                            <div class="col-md-11" >
                                              <select class="form-control" id="class" name="class" required="true">
                                                ...
                                                <option value="3">GIL1</option>
                                                <option value="4">GINF1</option>
                                                <option value="5">GSTR1</option>
                                                <option value="6">GSEA1</option>
                                                <option value="7">G3EI1</option>
                                                <option value="8">GINF2</option>
                                              </select>
                                                </div> </div>
                                                <br>
                                                <div class="form-group row">
