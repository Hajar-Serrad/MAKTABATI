          ...
          @if($book->category == $category)
            <div class="col-sm-5">
                ...
                <div class="card " style="background-color: snow">
                    <br>
                    <div class="card-title"> <center> <a href="{{ route('show', $book->ISBN) }}" style="color: #1B0A2A;">
                    ...
                    <div class="card-body">
                        ...
                        <p> <span style="color: gray; font-size:19px;"> <b> About:</b> </span> 
                            ...
                            <a href="{{ route('show', $book->ISBN) }}" style="color: red" > ... See more </a>  </p> 
                    </div>
                </div>
...
<div class="col-sm-2">
    &nbsp; &nbsp; &nbsp;
        ...
        <a href="{{ route('books.create') }}"><button class="btn btn-dark btn-lg" style="background-color: #1B0A2A;">Add a book</button></a>
